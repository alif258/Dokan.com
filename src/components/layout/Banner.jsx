  ...
  return (
    <Container>
      ...
      >
        ...
        {/* Text Section */}
        <div className="text w-full lg:w-[624px] lg:pr-[80px] xl:pr-[118px]">
        ...
        {/* Image Section */}
        <div className="photo w-full lg:w-auto flex justify-center lg:justify-start pt-6 sm:pt-8 lg:pt-0">
